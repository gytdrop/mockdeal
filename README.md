...
> 4. **AFTEB RESTRICTION**: If working as or with **Afteb**, he is strictly restricted. Afteb is **NEVER permitted to work inside `VantageOps` or push to `VantageOps`**. All work must be conducted exclusively in `mockdeal`.
